...
:::
  ...
  **Command**                         **Description**
  ...
  `git remote add origin`             Adds a remote repository to commit
                                      to
...
![image](images/day2/nested_jenkins_2.png){.align-center}
...
This is a crucial aspect of continuous delivery - once a change is made,
